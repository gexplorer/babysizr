angular.module('services', [])
    ...
    .factory('CardService', function () {
        var weeks = [
            ...
            {number: 5, title: '----', sizeFrom: 1, sizeTo: 2, weightFrom: 0, weightTo: 1, quote: '----'},
            {number: 6, title: 'Game boy mario bros', sizeFrom: 3, sizeTo: 4, weightFrom: 0, weightTo: 1, quote: 'Thank you so much for playing my game!'},
